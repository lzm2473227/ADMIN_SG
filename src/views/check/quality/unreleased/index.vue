<template>
  <div class="tab">
    <div class="tab-title">
      <div class="left">
        <div class="print" @click="addMachine()"><img class="icon" src="@/assets/images/add.png" alt=""><span class="axis">新建审批件</span></div>
        <div class="print" @click="addMachine('1')"><img class="icon" src="@/assets/images/edit.png" alt=""><span class="axis">编辑审批件</span></div>
  ...
  methods: {
    ...
    addMachine(val, data) {
      if(val){
        ...
        this.$router.push({path: "/check/quality/unreleaseQualityInfo"});
      }
    },
    // 机具图片预览
    onPre(data){
