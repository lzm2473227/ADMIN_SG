  ...
  <div class="tab">
    <div class="tab-title">
      <div class="left">
        ...
        <div class="print" @click="forward"><img class="icon" src="@/assets/images/agreementForm.png" alt="" /><span class="axis">转发订单</span></div>
    ...
    <div class="table-main">
      <form action="" class="info-form">
        ...
        <table border="1" class="">
            <tr>
                <td class="table-left" style="padding: 0;">订单编号</td>
                <td class="table-right">
                    <input type="text" placeholder="请输入订单编号" v-model="form.fileTitle" />
                </td>
                <td class="table-left">订单主题</td>
                <td class="table-right" colspan="3">
                    <input type="text" placeholder="请输入订单主题" v-model="form.fileTitle" />
                </td>
            </tr>
            <tr>
                <td class="table-left">订单呈报人</td>
                <td class="table-right">
                <input type="text" placeholder="请输入订单呈报人" v-model="form.fileCode" />
                </td>
            ...
            <tr>
                ...
                <td class="table-right">
                <input type="text" placeholder="请输入店铺名称" v-model="form.reportTime" />
                </td>
            ...
            <tr>
                <td class="table-left">订单主件</td>
                <td class="table-right" colspan="5">
                    <div class="file-content"><span>点击查看订单主件内容</span></div>
                </td>
            </tr>
            <tr>
                <td class="table-left">报价呈报人</td>
                <td class="table-right">
                <input type="text" placeholder="请输入报价呈报人" v-model="form.fileCode" />
                </td>
                <td class="table-left">所在部门</td>
                <td class="table-right">
                <input type="text" placeholder="请输入所在部门" v-model="form.fileName" />
            ...
            <tr>
                ...
                <td class="table-right" colspan="5">
                    ...
                    <div class="file-content"><span>点击查看报价主件内容</span></div>
                </td>
            </tr>
            <tr>
