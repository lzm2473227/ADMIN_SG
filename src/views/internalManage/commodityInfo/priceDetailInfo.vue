        ...
        <table border="1" class="">
          <tr>
            ...
            <td class="table-right" colspan="3">
              <input type="text" placeholder="关于xxx的价格信息审批" v-model="form.title" :disabled="isDisabled"/>
            </td>
          </tr>
          <tr>
            ...
            <td colspan="3">
                <tr>
                    ...
                    <td class="table-right sub-table-right">
                      ...
                      <span v-show="!isDisabled && !$route.query.barcode" @click="addDrand('1')" class="choose-commodity">选择商品</span>
                    </td>
            ...
            <td class="table-left table-vertical"><span>普</span><span>通</span><span>价</span><span>格</span></td>
              <td colspan="3">
                ...
                <tr>
                    ...
                    <td class="table-right sub-table-right">
                      <input type="text" placeholder="普通零售价" v-model="serviceParam.retailPrice" :disabled="isDisabled"/>
                      <span class="unit">元</span>
                    </td>
                    <td class="table-left sub-table-left">零售起订量</td>
                    <td class="table-right sub-table-right" style="border-right: none">
                      <input type="text" placeholder="零售起订量" v-model="serviceParam.retailMinimumQuantity" :disabled="isDisabled"/>
                    </td>
                </tr>
                <tr>
                    <td class="table-left sub-table-left">普通批发价</td>
                    <td class="table-right sub-table-right">
                      <input type="text" placeholder="普通批发价" v-model="serviceParam.tradePrice" :disabled="isDisabled"/>
                      <span class="unit">元</span>
                    </td>
                ...
                <tr>
                    ...
                    <td class="table-right sub-table-right" colspan="3" style="border-right:none;border-bottom:none">
                      <div class="file-button" v-show="!isDisabled">
                        <button type='button' @click="addDrand('2')"><img src="@/assets/images/file-add.png" alt="">设置</button>
            ...
            <td class="table-left table-vertical"><span>特</span><span>惠</span><span>价</span><span>格</span></td>
              <td colspan="3">
                ...
                <tr>
                    <td class="table-left sub-table-left">普通零售价</td>
                    <td class="table-right sub-table-right">
                        <input type="text" placeholder="普通零售价" v-model="serviceParam.preferentialRetailPrice" :disabled="isDisabled"/>
                        <span class="unit">元</span>
                    </td>
                    <td class="table-left sub-table-left">零售起订量</td>
                    <td class="table-right sub-table-right" style="border-right: none">
                        <input type="text" placeholder="零售起订量" v-model="serviceParam.pRetailMinimumQuantity" :disabled="isDisabled"/>
                    </td>
                </tr>
                <tr>
                    <td class="table-left sub-table-left">普通批发价</td>
                    <td class="table-right sub-table-right">
                        <input type="text" placeholder="普通批发价" v-model="serviceParam.preferentialTradePrice" :disabled="isDisabled"/>
                        <span class="unit">元</span>
                    </td>
                    <td class="table-left sub-table-left">批发起订量</td>
                    <td class="table-right sub-table-right" style="border-right: none">
                        <input type="text" placeholder="批发起订量" v-model="serviceParam.pTradeMinimumQuantity" :disabled="isDisabled"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="table-right sub-table-right" colspan="3" style="border-right:none;border-bottom:none">
                      <div class="file-button" v-show="!isDisabled">
                        <button type='button' @click="addDrand('3')"><img src="@/assets/images/file-add.png" alt="">设置</button>
                        <!-- <button type='button'><img src="@/assets/images/file-edit.png" alt="">修改</button> -->
                        <!-- <button type='button'><img src="@/assets/images/file-del.png" alt="">删除</button> -->
                      </div>
                      <el-table
      ...
      <div class="dialog-content" style="width: 620px">
        ...
        <div class="dialog-body table-main">
          ...
          >
            ...
            <el-table-column prop="brandName" label="品牌" show-overflow-tooltip width="140"></el-table-column>
          </el-table>
  ...
  methods: {
    async init(){
      ...
      if(this.$route.query.barcode){
        this.commodityInfo(this.$route.query.barcode)
        let params = {
          "object": {
    ...
    async getAddFile(val) {
      ...
      let state = 0
      let isSubmit = false
      let documentType = this.$route.query.barcode ? 'JGBJ' : 'JGSP'
    ...
    onSure(){
      if(this.characteristic  === '1'){
        ...
        this.commodityInfo(this.multipleSelection[0].barcode)
      }
    ...
    getCommodityList() {
      ...
      this.$API.commodityInfo.undeterminedPriceCommodityList(params).then(res => {
          ...
          _.forEach(res.data, function (item, key) {
            item.index = len[key]
            if(item.brandName === '') item.brandName = '无'
