  ...
  <div class="tab">
    ...
    <div class="tab-body inside-table">
      ...
      >
        ...
        ></el-table-column>
        <el-table-column prop="ceView" label="交易中心类目" sortable show-overflow-tooltip></el-table-column>
...
export default {
  ...
  methods: {
    ...
    editproduct(data) {
      this.$router.push({
        path: "/internalManage/commodityInfo/publishedDetailInfo",
        query: {
          documentId: data.barcode,
        },
      });
    },
    // 机具图片预览
