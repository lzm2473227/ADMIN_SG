  ...
  <div class="tab">
    ...
    <div class="tab-body inside-table">
      ...
      >
        ...
        <el-table-column label="商品条形码" align="center" sortable width="150">
          <template v-slot="scope">
            <span class="detail-info" @click="onAdd(scope.row)">{{scope.row.barcode}}</span>
          </template>
        </el-table-column>
        <el-table-column prop="commodityName" label="商品名称" sortable width="180" show-overflow-tooltip></el-table-column>
        <el-table-column prop="specsParameter" label="规格" sortable width="160" show-overflow-tooltip></el-table-column>
        <el-table-column prop="brandName" label="品牌" sortable width="170" show-overflow-tooltip ></el-table-column>
        <el-table-column prop="ceView" label="交易中心类目" sortable width="170" show-overflow-tooltip></el-table-column>
        <el-table-column prop="enView" label="公司内部类目" sortable width="170" show-overflow-tooltip></el-table-column>
        <el-table-column prop="retailPrice" label="普通零售价" sortable width="140" show-overflow-tooltip ></el-table-column>
        <el-table-column prop="tradePrice" label="普通批发价" sortable width="140" show-overflow-tooltip ></el-table-column>
        <el-table-column prop="preferentialRetailPrice" label="特惠零售价" sortable width="140" show-overflow-tooltip ></el-table-column>
        <el-table-column prop="preferentialTradePrice" label="特惠批发价" sortable width="140" show-overflow-tooltip ></el-table-column>
        <el-table-column label="特惠时间段" sortable width="170" show-overflow-tooltip align="center">
          <template v-slot="scope">
        ...
        <el-table-column prop="state" label="状态" align="center" sortable width="100" >
          <template v-slot="scope">
            <el-tag v-if="scope.row.state === 1" type="success" disable-transitions>已上架</el-tag>
            <el-tag v-if="scope.row.state === 0" type="danger" disable-transitions>未上架</el-tag>
          </template>
        </el-table-column>
        <el-table-column prop="updateTime" label="更新时间" align="center" sortable width="160"></el-table-column>
      </el-table>
    </div>
    <div class="bot">
...
export default {
  ...
  methods: {
    async getdata() {
      ...
      let res = await this.$API.commodityInfo.publishedCommodityList(params)
        console.log(res);
          let data = res.data;
    ...
    onAdd(data){
      this.$router.push({
        path: "/internalManage/commodityInfo/publishedPriceDetailInfo",
        query: {
