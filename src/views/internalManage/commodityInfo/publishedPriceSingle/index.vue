  ...
  <div class="tab">
    ...
    <div class="tab-body inside-table">
      ...
      >
        ...
        <el-table-column label="单品编码" align="center" sortable width="190">
          <template v-slot="scope">
            <span class="detail-info" @click="onAdd(scope.row)">{{scope.row.commodityCode}}</span>
          </template>
        </el-table-column>
        <el-table-column prop="barcode" label="商品条形码" align="center" sortable width="150"></el-table-column>
        ...
        <el-table-column prop="brandName" label="品牌" sortable width="170" show-overflow-tooltip
        ></el-table-column>
        ...
        <el-table-column prop="retailPrice" label="单品普通售价" sortable width="140" show-overflow-tooltip></el-table-column>
        <el-table-column prop="preferentialRetailPrice" label="单品特惠售价" sortable width="140" show-overflow-tooltip></el-table-column>
        <el-table-column label="特惠时间段" sortable width="170" show-overflow-tooltip align="center" >
          <template v-slot="scope">
            <span>起{{scope.row.preferentialStartTime}}</span><br>
...
export default {
  ...
  methods: {
    async getdata() {
      ...
      let res = await this.$API.commodityInfo.publishedCommodityCodeList(params)
        console.log(res);
          let data = res.data;
    ...
    onAdd(data){
      this.$router.push({
        path: "/internalManage/commodityInfo/publishedPriceSingleInfo",
        query: {
