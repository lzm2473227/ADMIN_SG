<template>
  <div class="tab">
    <div class="tab-title">
      <div class="left">
        <div class="print" @click="addMachine()" v-show="code === 'NATIONAL_DISTRIBUTOR'">
          <img class="icon" src="@/assets/images/add.png" alt="" /><span class="axis">新增审批件</span>
        </div>
        <div class="print" @click="addMachine('1')" v-show="code === 'NATIONAL_DISTRIBUTOR'">
  ...
  methods: {
    ...
    addMachine(val, data) {
      ...
      if(val){
        ...
        this.$router.push({path: "/internalManage/commodityInfo/commodityDetailInfo"});
      }
    },
    addProduct() {
      this.$router.push("/internalManage/commodityInfo/commodityDetailInfo");
    },
    delproduct() {
