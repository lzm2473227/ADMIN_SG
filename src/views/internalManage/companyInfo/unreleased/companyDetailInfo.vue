<template>
  <div class="tab">
    <div class="tab-title">
      <div class="left">
        <!-- <div class="print" @click="toBackList" v-show="isListLen"><img class="icon" src="@/assets/images/back.png" alt=""/><span class="axis">返回列表</span></div> -->
        ...
        <div class="print" @click="forward" v-show="isListLen"><img class="icon" src="@/assets/images/relay.png" alt="" /><span class="axis">转内部审核</span></div>
        ...
        <div class="print" @click="onState" v-show="isListLen"><img class="icon" src="@/assets/images/status.png" alt="" /><span class="axis">查看状态</span></div>
        <!-- <div class="print" @click="toPlatform('2')" v-show="!isListLen"><img class="icon" src="@/assets/images/relay.png" alt="" /><span class="axis">转平台审核</span></div> -->
      </div>
      <div class="right">
      </div>
    </div>
        ...
        <table border="1" class="">
          <tr>
            ...
            <td class="table-right" colspan="3">
              <input type="text" placeholder="关于xxx的信息审批" v-model="form.title" :disabled="isDisabled"/>
            </td>
          </tr>
          <tr>
            ...
            <td colspan="3">
              <tr>
                <td class="table-right" style="width: 0;border: none;">
                  <span v-if="form.documentNumber" style="width: 170px;display: inline-block;">{{form.documentNumber}}</span>
                  <span v-else style="width: 170px;display: inline-block;">系统分配</span>
                </td>
        ...
        <table border="1" class="">
          <tr>
            ...
            <td class="table-right">
              <span v-if="documentId || $route.query.id || $store.state.user.enterpriseId">{{registerEnterpriseDto.orgCode}}</span>
              <input v-else type="text" placeholder="请输入所在机构代码" v-model="registerEnterpriseDto.orgCode" />
            </td>
            <td class="table-left">所在机构名称</td>
            <td class="table-right">
              <input type="text" placeholder="请输入所在机构名称" v-model="registerEnterpriseDto.orgName" />
            </td>
          </tr>
          <tr>
            <td class="table-left">法定代表人<br>姓名</td>
            <td class="table-right">
              <input type="text" placeholder="请输入法定代表人姓名" v-model="registerEnterpriseDto.legalPersonName" />
            </td>
            <td class="table-left">法定代表人<br>身份证号</td>
            <td class="table-right">
              <input type="text" placeholder="请输入法定代表人身份证号" v-model="registerEnterpriseDto.legalPersonIdNumber" />
            </td>
          </tr>
          <tr>
            <td class="table-left">注册人手机</td>
            <td class="table-right" style="width: 360px;">
              <input type="text" placeholder="请输入注册人手机" v-model="registerEnterpriseDto.telNum" />
            </td>
            <td class="table-left">电子邮箱</td>
            <td class="table-right" style="width: 260px;">
              <input type="text" placeholder="请输入电子邮箱" v-model="registerEnterpriseDto.email" />
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="table-right" colspan="3">
              <input type="text" placeholder="请输入机构详细地址" v-model="registerEnterpriseDto.address" />
            </td>
          </tr>
          <tr style="vertical-align: top;">
          ...
          <tr>
            ...
            <td class="table-right" colspan="3">
              <input type="text" placeholder="请输入机构网址" v-model="registerEnterpriseDto.enterpriseUrl" />
            </td>
          </tr>
          <tr>
            <td class="table-left">公司类型</td>
            <td class="table-right">
              <el-select v-model="registerEnterpriseDto.enterpriseType" placeholder="请选择公司类型" :disabled="isDisabled">
                <el-option
            ...
            <td class="table-right">
              <input type="text" placeholder="请输入备注信息" v-model="registerEnterpriseDto.remark" />
            </td>
          </tr>
          <tr>
            ...
            <td colspan="3">
              <tr>
                ...
                <td class="table-right sub-table-right found-time">
                  <el-date-picker v-model="enterpriseBusinessLicenseEntity.dateOfEstablishment" type="date" placeholder="选择日期" value-format="yyyy-MM-dd"></el-date-picker>
                </td>
                <td class="table-left sub-table-left">注册资本</td>
                <td class="table-right sub-table-right" style="border-right: none">
                  <input type="number" placeholder="请输入注册资本" v-model="enterpriseBusinessLicenseEntity.registeredCapital" />
              ...
              <tr>
                ...
                <td class="table-right sub-table-right" colspan="3">
                  <el-date-picker class="operating-date" v-model="enterpriseBusinessLicenseEntity.operatingPeriodStartDate" type="date" placeholder="选择开始日期" value-format="yyyy-MM-dd"></el-date-picker>
                  <span class="operating-txt">至</span>
                  <el-date-picker class="operating-date" :disabled="checkedOperating" v-model="enterpriseBusinessLicenseEntity.operatingPeriodEndDate" type="date" placeholder="选择结束日期" value-format="yyyy-MM-dd"></el-date-picker>
                  <el-checkbox style="margin-left: 12px" v-model="checkedOperating" @change="changeChecked">无限期经营</el-checkbox>
                  <!-- <el-date-picker
                    v-model="enterpriseBusinessLicenseEntity.operatingPeriod"
                    type="daterange"
                    range-separator="至"
              ...
              <tr>
                ...
                <td class="table-right sub-table-right" colspan="3" style="border-right:none;">
                  <textarea
                    ...
                    v-model="enterpriseBusinessLicenseEntity.businessScope"
                  ></textarea>
                </td>
              </tr>
              <tr>
            ...
            <td colspan="3">
              <tr>
                ...
                <td class="table-right sub-table-right">
                  <input type="text" placeholder="请输入纳税人识别号" v-model="enterpriseTaxEntity.taxpayerIdentificationNumber" />
                </td>
                <td class="table-left sub-table-left">纳税人类型</td>
                <td class="table-right sub-table-right" style="border-right: none">
                  <el-select v-model="enterpriseTaxEntity.taxpayerType" placeholder="请选择纳税人类型" :disabled="isDisabled">
                    <el-option
              ...
              <tr>
                ...
                <td class="table-right sub-table-right" colspan="3">
                  <input type="text" placeholder="请输入比如3%或者17%" v-model="enterpriseTaxEntity.taxTypeTaxCode" />
                </td>
              </tr>
              <tr>
...
export default {
  ...
  data() {
    return {
      ...
      categoryIdArr: [],
      isListLen: false,
      checkedOperating: false
    };
  },
  watch: {
    checkedOperating(newV){
      if(newV)this.enterpriseBusinessLicenseEntity.operatingPeriodEndDate = ''
    },
  ...
  created(){
    ...
    this.isListLen = this.$store.state.user.identityDtoList && this.$store.state.user.identityDtoList.length > 0 ? true : false
    if(this.$store.state.user.identityDtoList.length > 0) this.getEnterpriseId() // 判断是否有企业信息
  },
  methods: {
    // 获取企业信息
    async getEnterpriseId(){
      ...
      if(res.code === 'SUCCESS') this.registerEnterpriseDto.orgCode = res.data.enterpriseEntity.orgCode
    },
    async init(){
      ...
      if(this.$route.query.id){
        ...
        if(info.enterpriseEntity !== null){
          ...
          this.selectedOptions = TextToCode[this.registerEnterpriseDto.province][this.registerEnterpriseDto.city][this.registerEnterpriseDto.district].code
        }
        ...
        if(info.enterpriseBusinessLicenseEntity !== null){
          ...
          if(info.enterpriseBusinessLicenseEntity.operatingPeriodEndDate === null){ // 无限期经营
          ...
          // this.enterpriseBusinessLicenseEntity.operatingPeriod = `${moment(info.enterpriseBusinessLicenseEntity.operatingPeriodStartDate).format("YYYY-MM-DD")},${moment(info.enterpriseBusinessLicenseEntity.operatingPeriodEndDate).format("YYYY-MM-DD")}`.split(',')
        }
      }
      // 公文详情
      if(this.documentId){
        ...
        if(serviceParam.enterpriseBusinessLicenseEntity.operatingPeriodEndDate === null) this.checkedOperating = true // 无限期经营
        ...
        if(res.data.list)this.listLen = res.data.list.length
        this.selectedOptions = TextToCode[serviceParam.registerEnterpriseDto.province][serviceParam.registerEnterpriseDto.city][serviceParam.registerEnterpriseDto.district].code
        // 办理意见
    ...
    changeChecked(){
      if(!this.checkedOperating) this.enterpriseBusinessLicenseEntity.operatingPeriodEndDate = ''
    },
    // 新建编辑公文
    async getAddFile(val) {
      let reg = /^\d+(?=\.{0,1}\d+$|$)/
      if(!(reg.test(this.enterpriseBusinessLicenseEntity.registeredCapital))) return this.$message('请填入正确的注册资本')
      if(this.checkedOperating) this.enterpriseBusinessLicenseEntity.operatingPeriodEndDate = null // 无限期经营
      ...
      let lat = 0
      let lng = 0
      let documentType = this.$route.query.id ? 'GSBJ' : 'GSSP'
      if(this.$route.query.id) enterpriseId = this.$store.state.user.enterpriseId
      ...
      let params = {
        ...
        "object": {
          ...
          "state": state, // 0-未办件(新增公文),1-转已办件(新增公文时转已办件)
          "submit": isSubmit,
          ...
          "enterpriseBusinessLicenseEntity": {
            ...
            // "id": "string",
            "operatingPeriodEndDate": this.enterpriseBusinessLicenseEntity.operatingPeriodEndDate,
            "operatingPeriodStartDate": this.enterpriseBusinessLicenseEntity.operatingPeriodStartDate,
            "registeredCapital": parseFloat(this.enterpriseBusinessLicenseEntity.registeredCapital)
          },
          ...
          "enterpriseTaxEntity": {
            ...
            "taxpayerType": this.enterpriseTaxEntity.taxpayerType
          },
          // 基本信息
          "registerEnterpriseDto": {
            ...
            "enterpriseType": this.registerEnterpriseDto.enterpriseType,
            "latitude": lat,
    ...
    async submitForAudit(){
      ...
      //   }
      // }
      // let res = await this.$API.enterpriseInfo.registerSellerInfo(params)
      // if(res.code === 'SUCCESS'){
      //   this.$message.success('转平台审核成功，等待平台审核')
      //   if(!this.$store.state.user.enterpriseId){
      //     this.$store.dispatch('user/resetToken')
      //     this.$router.push('/login')
      //   }
      //   // let res1 = await this.$store.dispatch('user/getInfo')
      //   // if (res1.identityDtoList.length > 0) {
      //   //   await this.$store.dispatch('user/getEnterpriseId')
      //   // }
