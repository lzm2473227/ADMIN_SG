      ...
      <form action="">
        ...
        <table border="1" class="">
          ...
          <tr>
            ...
            <td class="table-right">
              <input type="text" placeholder="请输入所在部门" v-model="form.deptName" disabled/>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="table-right" colspan="5">
                <div class="file-button">
                    <button type='button'><img style="width:16px" src="@/assets/images/print.png" alt="">打印公文</button>
                </div>
          ...
          <tr>
            ...
            <td class="table-right" style="padding-top: 12px;height:100px;" colspan="5">
                <div class="file-button">
                    <button type='button'><img src="@/assets/images/Cloud Download On.png" alt="">打包下载</button>
                </div>
                <div class="file-content"><span>暂无公文内容</span></div>
            </td>
          </tr>
      ...
      <div class="dialog-content forward-con">
        ...
        <div class="dialog-body">
          ...
          <div v-for="(item,index) in items" :key="index" class="action">
            {{item.name}}: {{water.createTime}} <span class="bold">{{item.action}}</span><br />
          </div>
        </div>
      </div>
    </div>
