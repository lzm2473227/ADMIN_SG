<template>
  <div class="tab">
    <div class="tab-title">
      <div class="left">
        <div class="print" @click="addMachine('1')"><img class="icon" src="@/assets/images/add.png" alt=""><span class="axis">回复订单审批件</span></div>
    ...
    <div class="tab-body inside-table">
      ...
      >
        ...
        <el-table-column prop="limitTime" label="办结时间" align="center" sortable width="160"></el-table-column>
        <el-table-column label="呈报人" align="center" sortable width="160" ><template v-slot="scope">
  ...
  methods: {
    ...
    addMachine(val, data) {
      if(val){
        ...
        this.$router.push({
          path: "/internalManage/order/unreservedOrderInfo",
          query: {
            documentId: documentId,
          },
        });
      } else{
        this.$router.push({path: "/internalManage/order/unreservedOrderInfo"});
      }
    },
    // 机具图片预览
    onPre(data){
