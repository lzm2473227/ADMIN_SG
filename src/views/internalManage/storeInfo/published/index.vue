  ...
  <div class="tab">
    ...
    <div class="tab-body inside-table">
      ...
      >
        ...
        <el-table-column label="店铺编码" show-overflow-tooltip align="center" sortable width="170">
          <template v-slot="scope">
            <span class="detail-info" @click="onAdd(scope.row)">{{scope.row.storeCode}}</span>
          </template>
        </el-table-column>
        <el-table-column prop="storeName" show-overflow-tooltip label="店铺名称" sortable width="220"></el-table-column>
        <el-table-column prop="attributionDepartment" label="归属部门" show-overflow-tooltip align="center" sortable width="150"></el-table-column>
        <el-table-column prop="storeIntroduce" label="店铺介绍" sortable show-overflow-tooltip></el-table-column>
        <el-table-column prop="storeServicePhone" label="客服电话" sortable width="180" align="center"></el-table-column>
        <el-table-column prop="time" label="办结时间" align="center" sortable width="160"></el-table-column>
