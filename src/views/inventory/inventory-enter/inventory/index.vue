<template>
 <div class="tab">
    <div class="tab-title">
      <div class="left">
        <div class="print"><img class="icon" src="../../../../assets/images/back-commodity.png" alt=""><span class="axis">撤回入库商品</span></div>
        <div class="print"><img class="icon" src="@/assets/images/ic-examine.png" alt=""><span class="axis">查看新增入库</span></div>
        <div class="print"><img class="icon" src="@/assets/images/statistics.png" alt=""><span class="axis">按仓库统计</span></div>
    ...
    <div class="tab-body inside-table">
      ...
      >
        ...
        <el-table-column prop="equipmentSupplier" label="实际库存" width="100" sortable show-overflow-tooltip align="center"></el-table-column>
        <el-table-column prop="equipmentSupplier" label="所属仓库" width="220" sortable show-overflow-tooltip align="center"></el-table-column>
        <el-table-column prop="equipmentSupplier" label="更新时间" width="220" sortable show-overflow-tooltip align="center"></el-table-column>
      </el-table>
    </div>
    <div class="bot">
