<template>
  <div class="tab">
    <div class="tab-title">
      <div class="left">
        <div class="print" @click="onBack" v-show="code === 'NATIONAL_DISTRIBUTOR'"><img class="icon" src="@/assets/images/recall.png" alt=""><span class="axis">撤回审批件</span></div>
        ...
        <div class="print" @click="toPlatform()"><img class="icon" src="@/assets/images/code.png" alt="" /><span class="axis">提交平台物流申请</span></div>
      </div>
      <div class="right">
        <div class="setup">
    ...
    <div class="tab-body inside-table">
      ...
      >
        ...
        <!-- <el-table-column prop="commodityName" show-overflow-tooltip label="配送商品" sortable width="200"></el-table-column>
        <el-table-column prop="specsParameter" label="配送数量" show-overflow-tooltip align="center" sortable width="120"></el-table-column>
        <el-table-column prop="brandName" label="物流承运方" sortable show-overflow-tooltip width="180"></el-table-column> -->
        <el-table-column prop="handleTime" label="办结时间" align="center" sortable width="160"></el-table-column>
        <el-table-column label="呈报人" align="center" sortable width="160" >
          <template v-slot="scope">
            <span>{{scope.row.reportName}}</span>
          </template>
        </el-table-column>
        <el-table-column label="最后经办人" align="center"  sortable width="150" >
          <template v-slot="scope">
