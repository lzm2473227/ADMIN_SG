  ...
  <div class="tab">
    <div class="tab-title">
      <div class="left">
        ...
        <div class="print" @click="onAdd('1')" v-show="code === 'NATIONAL_DISTRIBUTOR'"><img class="icon" src="@/assets/images/edit.png" alt=""><span class="axis">编辑物流审批件</span></div>
        <div class="print" @click="delMachine" v-show="code === 'NATIONAL_DISTRIBUTOR'"><img class="icon" src="@/assets/images/delete.png" alt=""><span class="axis">删除物流审批件</span></div>
    ...
    <div class="tab-body inside-table">
      ...
      >
        ...
        <el-table-column prop="specsParameter" label="配送数量" show-overflow-tooltip align="center" sortable width="150"></el-table-column>
        <el-table-column prop="brandName" label="物流承运方" sortable show-overflow-tooltip></el-table-column> -->
  ...
  methods: {
    ...
    onAdd(val, data) {
      if(val){
        ...
        this.$router.push({path: "/logistics/unreleasedLogisticsInfo"});
      }
    },
    // 机具图片预览
    onPre(data){
