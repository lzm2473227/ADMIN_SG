 ...
 <div class="tab">
    <div class="tab-title">
      <div class="left">
        ...
        <div class="print"><img class="icon" src="../../../assets/images/ic-money.png" alt=""><span class="axis">确认收款</span></div>
      </div>
      <div class="right">
      </div>
    </div>
    <div class="tab-body inside-table">
      ...
      >
        ...
        <el-table-column prop="equipmentModel" label="收款单号 (拟) " width="160" show-overflow-tooltip align="center" sortable ></el-table-column>
