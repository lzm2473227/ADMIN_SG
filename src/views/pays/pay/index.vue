 ...
 <div class="tab">
    ...
    <div class="tab-body inside-table">
      ...
      >
        ...
        <el-table-column prop="equipmentModel" label="收款单号" width="160" show-overflow-tooltip align="center" sortable ></el-table-column>
        <el-table-column prop="equipmentModel" label="合同编号" width="160" show-overflow-tooltip align="center" sortable ></el-table-column>
        <el-table-column prop="equipmentModel" label="合同金额 (元) " width="164" align="center" sortable ></el-table-column>
        <el-table-column prop="equipmentName" label="收款说明" width="160" show-overflow-tooltip align="center" sortable></el-table-column>
        <el-table-column prop="equipmentSupplier" label="收款金额 (元) " width="144" sortable show-overflow-tooltip align="center"></el-table-column>
        <el-table-column prop="storeName" label="付款方 (买方) " sortable show-overflow-tooltip align="center"></el-table-column>
