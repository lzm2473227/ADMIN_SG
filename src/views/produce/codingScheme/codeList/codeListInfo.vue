  ...
  methods: {
    async init(){
      ...
      if(this.documentId){
        ...
        if(!this.serviceParam.codeCommEntity.chang) this.serviceParam.codeCommEntity.chang = 0
        if(!this.serviceParam.codeCommEntity.kuan) this.serviceParam.codeCommEntity.kuan = 0
        if(!this.serviceParam.codeBoxEntity.chang) this.serviceParam.codeBoxEntity.chang = 0
        if(!this.serviceParam.codeBoxEntity.kuan) this.serviceParam.codeBoxEntity.kuan = 0
        if(!this.serviceParam.codeStackEntity.chang) this.serviceParam.codeStackEntity.chang = 0
        if(!this.serviceParam.codeStackEntity.kuan) this.serviceParam.codeStackEntity.kuan = 0
        if(!this.serviceParam.codeCommEntity.qrCodeUrl) this.serviceParam.codeCommEntity.qrCodeUrl = '无'
        if(!this.serviceParam.codeBoxEntity.qrCodeUrl) this.serviceParam.codeBoxEntity.qrCodeUrl = '无'
        if(!this.serviceParam.codeStackEntity.qrCodeUrl) this.serviceParam.codeStackEntity.qrCodeUrl = '无'
        if(!this.serviceParam.codeCommEntity.printerPosition) this.serviceParam.codeCommEntity.printerPosition = '无'
        if(!this.serviceParam.codeBoxEntity.printerPosition) this.serviceParam.codeBoxEntity.printerPosition = '无'
        if(!this.serviceParam.codeStackEntity.printerPosition) this.serviceParam.codeStackEntity.printerPosition = '无'
