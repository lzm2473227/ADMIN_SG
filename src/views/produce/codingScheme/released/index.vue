  ...
  <div class="tab">
    <div class="tab-title">
      <div class="left">
        ...
        <!-- <div class="print" @click="toPlatform()"><img class="icon" src="@/assets/images/code.png" alt="" /><span class="axis">生成编码计划</span></div> -->
      </div>
      <div class="right">
        <div class="setup">
  ...
  methods: {
    ...
    onAdd(data) {
      ...
      if(data){
        ...
        if(this.multipleSelection.length != 1) return this.$message('请选择一项需要生成的编码计划')
        documentId = this.multipleSelection[0].id
      }
      this.$router.push({
        path: "/produce/codingScheme/releasedCodingSchemeInfo",
        query: {
