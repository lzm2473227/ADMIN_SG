  ...
  <div class="tab">
    ...
    <div class="tab-body inside-table">
      ...
      >
        ...
        <el-table-column label="编码" show-overflow-tooltip align="center" sortable width="300">
          <template v-slot="scope">
            <span class="detail-info" @click="onAdd(scope.row)">{{scope.row.number}}</span>
          </template>
        </el-table-column>
        <el-table-column label="编码类型" align="center" sortable width="100">
          <template v-slot="scope">
        ...
        <el-table-column prop="specsParameter	" show-overflow-tooltip label="产品规格" sortable width="170"></el-table-column>
        <el-table-column prop="brandName	" label="产品品牌" show-overflow-tooltip sortable width="180"></el-table-column>
        <el-table-column label="编码计划编号" show-overflow-tooltip align="center" sortable width="180">
          <template v-slot="scope">
            <span class="detail-info" @click="onAdd(scope.row)">{{scope.row.idNumber}}</span>
          </template>
        </el-table-column>
...
export default {
  ...
  methods: {
    async getdata() {
      ...
      let res = await this.$API.code.queryCodeAllByEnterpriseId(params)
        console.log(res);
          let data = res.data;
