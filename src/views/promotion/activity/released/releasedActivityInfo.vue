    ...
    <div class="table-main">
      <form action="" class="info-form">
        ...
        <table border="1" class="">
          ...
          <tr style="vertical-align: top" v-show="serviceParam.urlType === '1' && picRadio === '1'">
...
export default {
  ...
  methods: {
    async init(){
      ...
      if(this.documentId){
        ...
        switch (this.serviceParam.locationId){
            case '1':
                this.serviceParam.location = '首页活动专栏'
                break
            case '2':
                this.serviceParam.location = '店铺特惠活动'
                break
        }
    ...
    async submitForAudit(){
      ...
      // this.serviceParam.endTime = this.serviceParam.time[0]
