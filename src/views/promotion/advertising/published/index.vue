  ...
  <div class="tab">
    ...
    <div class="tab-body inside-table">
      ...
      >
        ...
        <el-table-column label="广告编号" show-overflow-tooltip align="center" sortable width="170">
          <template v-slot="scope">
            <span class="detail-info" @click="onAdd(scope.row)">{{scope.row.advertisementNumber}}</span>
          </template>
        </el-table-column>
        <el-table-column prop="advertisementName" show-overflow-tooltip label="广告名称" sortable width="220"></el-table-column>
        <el-table-column prop="name" label="广告位置" show-overflow-tooltip align="center" sortable width="150"></el-table-column>
        <el-table-column prop="advertisementDescribe" label="广告简述" sortable show-overflow-tooltip></el-table-column>
...
export default {
  ...
  methods: {
    ...
    onAdd(data){
      this.$router.push({
        path: "/promotion/advertising/publishedAdvertisingInfo",
        query: {
          id: data.id,
        },
      })
