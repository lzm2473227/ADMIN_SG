<template>
  <div class="tab">
    <div class="tab-title">
      <div class="left">
        <div class="print" @click="onAdd()" v-show="code === 'NATIONAL_DISTRIBUTOR'"><img class="icon" src="@/assets/images/add.png" alt=""><span class="axis">新建审批件</span></div>
  ...
  methods: {
    ...
    onAdd(val, data) {
      if(val){
        ...
        this.$router.push({path: "/promotion/advertising/unreleasedAdvertisingInfo"});
      }
    },
    // 机具图片预览
    onPre(data){
