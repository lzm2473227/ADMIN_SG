  ...
  <div class="tab">
    <div class="tab-title">
      <div class="left">
        ...
        <div class="print" @click="onBack"><img class="icon" src="@/assets/images/ic-money.png" alt=""><span class="axis">提交到付款环节</span></div>
        <div class="print" @click="onBack"><img class="icon" src="@/assets/images/sure.png" alt=""><span class="axis">确认收货</span></div>
    ...
    <div class="tab-body inside-table">
      ...
      >
        ...
        <el-table-column prop="totalQuantity" label="商品数量" sortable width="110" align="center"></el-table-column>
        <el-table-column prop="commodityName" show-overflow-tooltip label="商品内容" sortable></el-table-column>
        <el-table-column prop="totalAmount" label="订单金额" align="center" sortable width="120"></el-table-column>
        <el-table-column prop="senterpriseName" label="销售方" sortable show-overflow-tooltip width="180"></el-table-column>
        <el-table-column prop="storeName" label="店铺名称" sortable show-overflow-tooltip width="180" align="center"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    onOrderDetail(data){
      this.$router.push({
        path: "/purchase/purchaseOrder/publishedOrderInfo",
        query: {
