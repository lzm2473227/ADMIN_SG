      ...
      <form action="" class="info-form">
        ...
        <table border="1" class="">
          ...
          <tr>
            ...
            <td class="table-right" style="width: 305px;">
              <span>{{serviceParam.senterpriseName}}</span>
            </td>
          </tr>
          <tr>
              ...
              >
                  ...
                  <el-table-column label="小计金额"  width="120" align="center" sortable show-overflow-tooltip>
                    <template v-slot="scope">
                      ...
                      <span>{{scope.row.tradePrice*scope.row.quantity}}</span>
                    </template>
                  </el-table-column>
          ...
          <tr style="vertical-align: top" v-show="radio2 === 1">
...
export default {
  ...
  created(){
    this.documentId = this.$route.query.dealNumber
  },
  methods: {
    async init(){
        let params = {
