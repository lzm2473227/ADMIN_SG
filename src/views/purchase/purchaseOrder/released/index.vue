  ...
  <div class="tab">
    ...
    <div class="tab-body inside-table">
      ...
      >
        ...
        <el-table-column label="呈报人" align="center" sortable width="160" show-overflow-tooltip >
          <template v-slot="scope">
        ...
        <el-table-column label="最后经办人" align="center" sortable width="150" show-overflow-tooltip >
          <template v-slot="scope">
            <span>{{scope.row.lastHandleName}}</span>
          </template>
        </el-table-column>
        <el-table-column label="是否转为交易订单" align="center" width="160" sortable>
          <template v-slot="scope">
...
export default {
  ...
  methods: {
    ...
    onAdd(data) {
      ...
      this.$router.push({
        path: "/purchase/purchaseOrder/releasedOrderInfo",
        query: {
