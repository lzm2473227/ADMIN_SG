  ...
  <div class="tab">
    ...
    <div class="tab-body inside-table">
      ...
      >
        ...
        <el-table-column prop="commodityName" show-overflow-tooltip label="商品名称" sortable width="220"></el-table-column>
        <el-table-column prop="specsParameter" label="规格" show-overflow-tooltip align="center" sortable width="150"></el-table-column>
        ...
        <el-table-column prop="retailPrice" label="零售价" sortable show-overflow-tooltip></el-table-column>
        <el-table-column prop="tradePrice" label="批发价" sortable show-overflow-tooltip></el-table-column>
        <el-table-column prop="quantity" label="批发起订量" sortable show-overflow-tooltip></el-table-column>
        <el-table-column prop="quantity" label="购买数量" sortable show-overflow-tooltip></el-table-column>
        <el-table-column prop="subTotal" label="小计金额" sortable show-overflow-tooltip></el-table-column>
...
export default {
  ...
  methods: {
    ...
    onOrder(){
      ...
      this.$router.push({
        path: "/purchase/purchaseOrder/unreleasedOrderInfo",
        query: {
          storeName: storeName,
