<template>
  <div class="tab">
    <div class="tab-title">
      <div class="left">
        <div class="print" @click="onBack"><img class="icon" src="@/assets/images/recall.png" alt=""><span class="axis">撤回入库单</span></div>
        <div class="print" @click="toPlatform()"><img class="icon" src="@/assets/images/code.png" alt="" /><span class="axis">转为入库单</span></div>
    ...
    <div class="tab-body inside-table">
      ...
      >
        ...
        <el-table-column label="入库单号" show-overflow-tooltip align="center" sortable width="170">
          <template v-slot="scope">
            <span class="detail-info" @click="onAdd('2', scope.row)">{{scope.row.documentNumber}}</span>
          </template>
        </el-table-column>
        <el-table-column prop="title" show-overflow-tooltip label="入库商品内容" sortable></el-table-column>
        <el-table-column prop="commodityName" show-overflow-tooltip label="入库商品" sortable width="200"></el-table-column>
        <el-table-column prop="specsParameter" label="入库数量" show-overflow-tooltip align="center" sortable width="120"></el-table-column>
        <el-table-column prop="brandName" label="入库仓库" sortable show-overflow-tooltip width="180"></el-table-column>
        <el-table-column prop="handleTime" label="入库时间" align="center" sortable width="160"></el-table-column>
        <el-table-column prop="state" label="发送平台状态" align="center" sortable width="130" >
          <template v-slot="scope">
  ...
  methods: {
    ...
    onAdd(val, data) {
      if(val){
        ...
        this.$router.push({
          path: "/logistics/releasedLogisticsInfo",
          query: {
            documentId: documentId,
          },
        });
      } else{
        this.$router.push({path: "/logistics/releasedLogisticsInfo"});
      }
    },
    async onBack(){
      if(this.multipleSelection.length !== 1) return this.$message('请选择一项审批件')
