    ...
    <div class="table-main">
      <form action="" class="info-form">
        ...
        <table border="1" class="">
          <tr>
            ...
            <td class="table-right" colspan="3">
              <input type="text" placeholder="关于xxx的订单审批" v-model="form.title" :disabled="isDisabled"/>
            </td>
          </tr>
          <tr>
        ...
        <table border="1" class="">
          ...
          <tr>
            ...
            <td class="table-right" style="width: 305px;">
                <!-- <el-radio-group v-model="radio2">
                    ...
                    <el-radio  v-model="radio2" :label="1" style="margin-left: 20px;">是</el-radio>
            </td>
          ...
          <tr style="vertical-align: top" v-show="radio2 === 0">
        ...
        <div class="quote-tab" v-show="radio2 === 1">
          <div class="tab-sub">
  ...
  methods: {
    getData(){
      ...
      if(!this.documentId){
        ...
        this.xunjiaList1 = JSON.parse(sessionStorage.getItem('orderList'))
        this.$nextTick(() => {
          this.orderList.forEach((row,index) => {
            this.$refs.orderTable.toggleRowSelection(row, true)
            row.index = index+1
            row.xunjia = parseFloat(row.tradePrice)
          })
        })
        this.$nextTick(() => {
          this.xunjiaList1.forEach((row,index) => {
      ...
      if(this.documentId){
        ...
        this.$nextTick(() => {
          this.orderList.forEach(row => {
            this.$refs.orderTable0.toggleRowSelection(row, true)
          })
        })
        // 询价
        if(this.radio2===1){
    ...
    async getAddFile(val) {
      ...
      this.serviceParam.isInquiry = this.radio2
      if(this.radio2 === 1){
        this.serviceParam.inquirySheetList[0] = this.xunjiaList1 // 询价1
      }
