  ...
  <div class="tab">
    <div class="tab-title">
      <div class="left">
        ...
        <div class="print" @click="onAdd('1')" v-show="code === 'NATIONAL_DISTRIBUTOR'"><img class="icon" src="@/assets/images/edit.png" alt=""><span class="axis">编辑审批件</span></div>
    ...
    <div class="tab-body inside-table">
      ...
      >
        ...
        <!-- <el-table-column prop="commodityName" show-overflow-tooltip label="订单金额" sortable width="220"></el-table-column>
        <el-table-column prop="specsParameter" label="询价单金额" show-overflow-tooltip align="center" sortable width="150"></el-table-column>
        <el-table-column prop="brandName" label="报价单金额" sortable show-overflow-tooltip></el-table-column>
  ...
  methods: {
    ...
    onAdd(val, data) {
      if(val){
        ...
        this.$router.push({path: "/purchase/purchaseOrder/unreleasedOrderInfo"});
      }
    },
    // 机具图片预览
    onPre(data){
