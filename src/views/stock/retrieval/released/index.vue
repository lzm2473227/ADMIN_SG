  ...
  <div class="tab">
    <div class="tab-title">
      <div class="left">
        ...
        <!-- <div class="print" @click="changeOrder" v-show="code === 'NATIONAL_DISTRIBUTOR'"><img class="icon" src="@/assets/images/recall.png" alt=""><span class="axis">转为交易订单</span></div> -->
        ...
        <!-- <div class="print" @click="toPlatform1()"><img class="icon" src="@/assets/images/relay.png" alt="" /><span class="axis">转平台审核</span></div> -->
    ...
    <div class="tab-body inside-table">
      ...
      >
        ...
        <!-- <el-table-column prop="commodityName" label="订单金额" align="center" sortable width="120"></el-table-column>
        <el-table-column prop="specsParameter" label="询价单金额" align="center" sortable width="120"></el-table-column>
        <el-table-column prop="brandName" label="报价单金额" align="center" sortable width="120"></el-table-column>
        ...
        <el-table-column label="呈报人" align="center" sortable width="140" show-overflow-tooltip >
          <template v-slot="scope">
        ...
        <el-table-column label="最后经办人" align="center" sortable width="140" show-overflow-tooltip >
          <template v-slot="scope">
            <span>{{scope.row.lastHandleName}}</span>
          </template>
        </el-table-column>
        <el-table-column label="是否转为出库单" align="center" width="140" sortable>
          <template v-slot="scope">
...
export default {
  ...
  methods: {
    ...
    onAdd(data) {
      ...
      this.$router.push({
        path: "/stock/retrieval/releasedRetrievalInfo",
        query: {
    ...
    toPlatform1(val){
      ...
      this.$confirm(msg, '提示', {
        ...
        this.submitForAudit1()
      }).catch(() => {})
    },
    // 转平台审核
    async submitForAudit1(){
        let id = this.$store.state.user.enterpriseId
        let par = {
        "creatorIdentityId": "",
