  ...
  <div class="tab">
    <div class="tab-title">
      <div class="left">
        ...
        <div class="print" @click="toPlatform('2')"><img class="icon" src="@/assets/images/relay.png" alt="" /><span class="axis">转为出库单</span></div>
        ...
        <table border="1" class="">
          ...
          <tr>
            ...
            <td class="table-right select-colspan3" colspan="3">
                <span>{{serviceParam.province}}{{serviceParam.city}}{{serviceParam.county}}</span>
            </td>
          </tr>
          <tr>
