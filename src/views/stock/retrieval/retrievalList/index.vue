<template>
  <div class="tab">
    <div class="tab-title">
      <div class="left">
        <div class="print" @click="onOrder()"><img class="icon" src="@/assets/images/add.png" alt=""><span class="axis">撤回已出库单</span></div>
    ...
    <div class="tab-body inside-table">
      ...
      >
        ...
        <el-table-column label="出库单编号" show-overflow-tooltip align="center" sortable width="140">
          <template v-slot="scope">
            <span class="detail-info" @click="onOrder(scope.row)">{{scope.row.oddNumbers}}</span>
          </template>
        </el-table-column>
        ...
        <el-table-column prop="oddComm" show-overflow-tooltip label="出库商品内容" sortable min-width="200"></el-table-column>
        <el-table-column prop="totalQuantity" label="出库数量" sortable show-overflow-tooltip align="center" width="100"></el-table-column>
        <el-table-column prop="warehouseName" label="出库仓库" show-overflow-tooltip align="center" sortable width="180"></el-table-column>
        <el-table-column prop="createTime" label="出库时间" sortable align="center" show-overflow-tooltip width="160"></el-table-column>
        <el-table-column prop="retailPrice" label="是否已提交物流" sortable show-overflow-tooltip align="center" width="140"></el-table-column>
        <el-table-column prop="receivingUnit" label="发送平台状态" sortable show-overflow-tooltip align="center" width="130"></el-table-column>
      </el-table>
    </div>
    <div class="bot">
  ...
  methods: {
    async getdata() {
      ...
      let params = {
       "object": {
          "enterpriseId": id,
          "oddStatus": 1 // 0-入库，1-出库
       },
        pageNum: this.pageNum,
        pageSize: this.pageSize
      }
      let res = await this.$API.stock.exWarehouseList(params)
        console.log(res);
          let data = res.data;
    ...
    onAdd(val) {
        ...
        let dealNumber = this.multipleSelection[0].dealNumber
        this.$router.push({
          path: "/stock/retrieval/unreleasedRetrievalInfo",
          query: {
