  ...
  <div class="tab">
    <div class="tab-title">
      <div class="left">
        ...
        <div class="print" @click="onAdd('1')"><img class="icon" src="@/assets/images/edit.png" alt=""><span class="axis">编辑出库审批件</span></div>
        <div class="print" @click="delMachine"><img class="icon" src="@/assets/images/delete.png" alt=""><span class="axis">删除出库审批件</span></div>
  ...
  methods: {
    ...
    onAdd(val, data) {
      if(val){
        ...
        this.$router.push({path: "/stock/retrieval/unreleasedRetrievalInfo"});
      }
    },
    // 机具图片预览
    onPre(data){
