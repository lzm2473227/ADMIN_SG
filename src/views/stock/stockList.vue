<template>
  <div class="tab">
    <div class="tab-title">
      <div class="left">
        <div class="print" @click="onAddBrand()"><img class="icon" src="@/assets/images/add.png" alt=""><span class="axis">新增仓库</span></div>
        <div class="print" @click="edit('1')"><img class="icon" src="@/assets/images/delete.png" alt=""><span class="axis">编辑仓库</span></div>
        <div class="print" @click="del()"><img class="icon" src="@/assets/images/add.png" alt=""><span class="axis">删除仓库</span></div>
        ...
        <!-- <div class="print" @click="exportExcel"><img class="icon" src="@/assets/images/status.png" alt=""><span class="axis">显示字段</span></div> -->
      </div>
      <div class="right">
        <div class="setup">
    ...
    <div class="tab-body inside-table">
      ...
      >
        ...
        <el-table-column label="仓库编码" show-overflow-tooltip align="center" sortable width="160">
          <template v-slot="scope">
            <span class="detail-info" @click="edit('2', scope.row)">{{scope.row.warehouseCode}}</span>
          </template>
        </el-table-column>
        <el-table-column prop="warehouseName" show-overflow-tooltip label="仓库名称" sortable width="150"></el-table-column>
        <el-table-column prop="contacts" label="仓库联系人" show-overflow-tooltip align="center" sortable width="130"></el-table-column>
        <el-table-column prop="contactNumber" label="联系人手机号" sortable show-overflow-tooltip align="center" width="130"></el-table-column>
        <el-table-column prop="address" label="仓库地址" sortable show-overflow-tooltip></el-table-column>
        <el-table-column prop="introduction" label="仓库介绍" sortable show-overflow-tooltip width="150"></el-table-column>
      </el-table>
    </div>
    <div class="bot">
