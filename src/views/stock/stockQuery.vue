  ...
  <div class="tab">
    ...
    <div class="tab-body inside-table">
      ...
      >
        ...
        <el-table-column label="产品条形码" show-overflow-tooltip align="center" sortable width="160">
        ...
        <el-table-column prop="address" label="单位" sortable show-overflow-tooltip align="center" width="100"></el-table-column>
        <el-table-column prop="address" label="总库存数量" sortable show-overflow-tooltip align="center" width="120"></el-table-column>
        <el-table-column prop="address" label="包装比例" sortable show-overflow-tooltip align="center" width="120"></el-table-column>
        <el-table-column prop="address" label="库存数量(箱)" sortable show-overflow-tooltip align="center" width="120"></el-table-column>
        <el-table-column prop="address" label="库存数量(单品)" sortable show-overflow-tooltip align="center" width="140"></el-table-column>
      </el-table>
    </div>
    <div class="bot">
