<template>
 <div class="tab">
    <div class="tab-title">
      <div class="left">
        <div class="print"><img class="icon" src="../../../assets/images/back-commodity.png" alt=""><span class="axis">撤回表单</span></div>
    ...
    <div class="tab-body inside-table">
      ...
      >
        ...
        <el-table-column prop="equipmentModel" label="提货单号" width="140" show-overflow-tooltip align="center" sortable ></el-table-column>
        <el-table-column prop="equipmentModel" label="合同编号" width="154" align="center" sortable ></el-table-column>
        <el-table-column prop="equipmentName" label="关联订单编号" width="160" show-overflow-tooltip align="center" sortable></el-table-column>
        <el-table-column prop="equipmentSupplier" label="提货数量" width="95" sortable show-overflow-tooltip align="center"></el-table-column>
        <el-table-column prop="storeName" label="提货商品内容" sortable show-overflow-tooltip align="center"></el-table-column>
        <el-table-column prop="address" label="收货人" sortable width="82" show-overflow-tooltip align="center"></el-table-column>
        <el-table-column prop="address" label="收货地址" sortable width="240" show-overflow-tooltip align="center"></el-table-column>
        <el-table-column prop="address" label="呈报时间" sortable width="152" show-overflow-tooltip align="center"></el-table-column>
        <el-table-column prop="address" label="呈报人 / 部门" sortable width="152" show-overflow-tooltip align="center"></el-table-column>
